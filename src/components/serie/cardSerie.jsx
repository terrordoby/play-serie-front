      ...
      <div className="rounded-md shadow-lg h-full ">
        <Link key={props.serie.id} href={`/serie/${props.serie.id}`}>
          <div key={props.serie.id}>
            <img  width={250} height={200} src={`http://localhost:3001/tmp/${props.serie.image}`} />
          </div>
        </Link>
        <div className="px-2">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex gap-1">
              <button className=" hover:scale-110" onClick={() => props.onAddStatusToSerie(props.serie.id, "DESEJO_ASSISTIR")} >
              ...
              <button className=" hover:scale-110" onClick={() => props.onAddStatusToSerie(props.serie.id, "GOSTEI")}>
